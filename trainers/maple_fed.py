"""maple original with renaming and visualization
"""
...
from trainers.maple import MaPLe, load_clip_to_cpu
...
class MaPLeFederated(TrainerX):
    ...
    def test(self, split="test", evaluate_train=False):
        ...
        # This relies heavily on the MaPLe class implementation.
        if hasattr(self.clients[0], 'test'):
            try:
                # The base MaPLe.test likely doesn't expect 'evaluate_train' directly
